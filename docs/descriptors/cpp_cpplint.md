...
Syntax: cpplint.py [--verbose=#] [--output=emacs|eclipse|vs7|junit|sed|gsed]
  ...
  Default linted extensions are ['hpp', 'cpp', 'cc', 'cxx', 'cu', 'c++', 'cuh', 'c', 'h++', 'hxx', 'h', 'hh'].
  ...
  Flags:
    ...
    extensions=extension,extension,...
      ...
      Examples:
        --extensions=hpp,cpp,cc,cxx,cu,c++,cuh,c,h++,hxx,h,hh
    ...
    headers=x,y,...
     ...
     (by default, only files with extensions {'hpp', 'cuh', 'h++', 'hxx', 'h', 'hh'} will be assumed to be headers)

      Examples:
        --headers=hpp,cuh,h++,hxx,h,hh
        --headers=hpp,hxx
        --headers=hpp
