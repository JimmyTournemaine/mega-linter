...
- Linter versions upgrades
  - [ansible-lint](https://ansible-lint.readthedocs.io/en/latest/) from 4.2.0 to **0.0.0** on 2021-02-09
  ...
  - [git_diff](https://git-scm.com) from 2.26.2 to **2.30.0** on 2021-02-09
